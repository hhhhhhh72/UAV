<template>
  <div class="admin-page">
    ...
    <van-tabs
      ...
      offset-top="46"
    >
        <van-tab title="订单管理" v-if="userRole === 'platform_admin'">
            <div class="data-list">
        ...
        <van-tab title="案例管理" v-if="userRole === 'platform_admin'">
        ...
        <van-tab title="用户管理" v-if="userRole === 'platform_admin'">
            <div style="padding: 12px;">
                <div style="display: flex; gap: 10px; margin-bottom: 12px;">
        ...
        <van-tab title="赛事管理" v-if="userRole === 'platform_admin' || userRole === 'association_admin'">
        ...
        <van-tab title="服务配置" v-if="userRole === 'platform_admin'">
            <div style="padding: 12px;">
...
const fetchData = async () => {
    try {
        ...
        if (userRole.value === 'association_admin' && activeTab.value !== 3) {
            activeTab.value = 3;
        }
    } catch (error) {
