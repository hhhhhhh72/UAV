  ...
  <div class="list-page">
    ...
    <div class="table-wrap">
      <el-table v-loading="loading" :data="listData" row-key="id" stripe border @selection-change="onSelectChange">
        ...
        <el-table-column prop="org" label="所属单位" width="150" />
    ...
    <el-dialog v-model="detailVisible" title="应急资源详情" width="600px">
      <template v-if="currentItem">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="型号">{{ currentItem.model || '-' }}</el-descriptions-item>
          <el-descriptions-item label="数量">{{ currentItem.quantity || 0 }}</el-descriptions-item>
          <el-descriptions-item label="所属单位">{{ currentItem.org || '-' }}</el-descriptions-item>
    ...
    <el-dialog v-model="formVisible" :title="formEdit?'编辑应急资源':'新增应急资源'" width="560px" destroy-on-close>
      <el-form :model="form" label-width="90px">
        ...
        <el-row :gutter="16"><el-col :span="12"><el-form-item label="型号"><el-input v-model="form.model"/></el-form-item></el-col><el-col :span="12"><el-form-item label="数量"><el-input-number v-model="form.quantity" :min="0" style="width:100%"/></el-form-item></el-col></el-row>
        <el-row :gutter="16"><el-col :span="12"><el-form-item label="所属单位"><el-input v-model="form.org"/></el-form-item></el-col><el-col :span="12"><el-form-item label="位置"><el-input v-model="form.location"/></el-form-item></el-col></el-row>
        <el-row :gutter="16"><el-col :span="12"><el-form-item label="联系人"><el-input v-model="form.contact_name"/></el-form-item></el-col><el-col :span="12"><el-form-item label="联系电话"><el-input v-model="form.contact_phone"/></el-form-item></el-col></el-row>
...
const form=reactive({id:'',name:'',res_type:'drone',model:'',quantity:0,org:'',location:'',contact_name:'',contact_phone:'',status:'available',notes:''})
const resetForm=()=>Object.assign(form,{id:'',name:'',res_type:'drone',model:'',quantity:0,org:'',location:'',contact_name:'',contact_phone:'',status:'available',notes:''})
