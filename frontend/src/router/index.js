...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'portfolios', component: () => import('@/views/admin/portfolios/PortfolioList.vue'), meta: { title: '品牌管理' } },
      ...
      { path: 'articles', component: () => import('@/views/admin/consolidated/NewsPage.vue'), meta: { title: '资讯管理' } },
