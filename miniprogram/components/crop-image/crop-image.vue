  ...
  <view v-if="visible" class="crop-mask" @touchmove.stop.prevent>
    <view class="crop-panel">
      <view class="crop-head">
        ...
        <text class="crop-ratio">21:9 比例</text>
      </view>
...
<script>
// 21:9 固定比例图片裁剪器（老式 canvas 接口，目标端为微信小程序）
...
// 单指拖动/双指缩放（最小缩放保证框内不露白）→ 确认导出 1680×720 jpg
export default {
  name: 'CropImage',
  props: {
