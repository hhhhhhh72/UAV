...
const categories = [
  { id: 'supply-demand', title: '产业供需对接', subtitle: '资源匹配 高效对接', icon: 'exchange', gradient: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)', subColor: '#ede9fe',
    subItems: [
      { id: 'demand-hall', name: '需求大厅', icon: 'bullhorn-o' },
      { id: 'supply-show', name: '供应展示', icon: 'shop-o' },
      { id: 'bid-quote', name: '竞标报价', icon: 'records-o' },
    ]},
  { id: 'training', title: '培训认证', subtitle: '专业考证 技能提升', icon: 'medal-o', gradient: 'linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)', subColor: '#cffafe',
    subItems: [
  ...
  { id: 'innovation', title: '产学研协同', subtitle: '科技成果 创新驱动', icon: 'certificate', gradient: 'linear-gradient(135deg, #7c3aed 0%, #4f46e5 100%)', subColor: '#ede9fe',
    subItems: [
      { id: 'achievements', name: '成果库', icon: 'star-o' },
      { id: 'challenges', name: '研发难题', icon: 'fire-o' },
    ]},
  { id: 'trade', title: '无人机交易', subtitle: '整机配件 一站购齐', icon: 'shopping-cart-o', gradient: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', subColor: '#fef3c7',
    subItems: [
      { id: 'drone-unit', name: '整机购买', icon: 'gem-o' },
      { id: 'repair', name: '维修服务', icon: 'setting-o' },
      { id: 'parts', name: '配件商城', icon: 'more-o' },
    ]},
  { id: 'brand', title: '活动与品牌', subtitle: '协会活动 会员展示', icon: 'star-o', gradient: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', subColor: '#d1fae5',
    subItems: [
      { id: 'events', name: '协会活动', icon: 'calendar-o' },
      { id: 'portfolios', name: '品牌展示', icon: 'shop-o' },
    ]},
  { id: 'insurance', title: '保险金融', subtitle: '全面保障 资金支持', icon: 'shield-o', gradient: 'linear-gradient(135deg, #ef4444 0%, #dc2626 100%)', subColor: '#fee2e2',
    subItems: [
      { id: 'policy', name: '无人机保单', icon: 'shield-o' },
      { id: 'annual', name: '年审服务', icon: 'clock-o' },
      { id: 'loan', name: '金融贷款', icon: 'gold-coin-o' },
    ]},
  { id: 'emergency', title: '应急资源协同', subtitle: '快速响应 资源调度', icon: 'fire-o', gradient: 'linear-gradient(135deg, #f97316 0%, #ea580c 100%)', subColor: '#ffedd5',
    subItems: [
...
function goToCategory(cat) {
  const m = { 'supply-demand': '/pages/demands/list', training: '/pages/training/courses', innovation: '/pages/achievements/list', trade: '/pages/services/detail?id=trade', brand: '/pages/events/list', insurance: '/pages/services/detail?id=insurance', emergency: '/pages/emergency/resources' }
  uni.navigateTo({ url: m[cat.id] || '/pages/services/detail?id='+cat.id })
}

function goToSubService(cat, sub) {
  const nav = { 'demand-hall': '/pages/demands/list', 'bid-quote': '/pages/demands/bid', pilot: '/pages/training/courses', achievements: '/pages/achievements/list', challenges: '/pages/challenges/list', events: '/pages/events/list', portfolios: '/pages/portfolios/list', 'rescue-case': '/pages/cases/index', 'resource-dispatch': '/pages/emergency/resources', caac: '/pages/study/index', utc: '/pages/study/index', 'hr-cert': '/pages/study/index' }
  uni.navigateTo({ url: nav[sub.id] || '/pages/services/detail?id='+sub.id })
}
</script>
