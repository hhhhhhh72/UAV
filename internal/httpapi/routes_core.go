...
func (s *Server) registerDemandRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("DELETE /api/v1/admin/demands/{id}", s.deleteDemand)
...
func (s *Server) registerTradingRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /api/v1/service-listings", s.createServiceListing)
	mux.HandleFunc("GET /api/v1/service-listings/{id}", s.getServiceListing)
	mux.HandleFunc("POST /api/v1/service-listings/{id}/favorite", s.toggleServiceListingFavorite)
	mux.HandleFunc("GET /api/v1/service-listings/favorites/mine", s.listMyServiceListingFavorites)
